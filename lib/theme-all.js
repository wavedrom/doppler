...
const wd = {
  '.wd-container': {
    ...
    width: 'round(down, calc(100% - var(--right-panel-width)), 1px)',
    height: 'round(down, calc(100% - 6px), 1px)',
    cursor: 'col-resize',
    transition: 'width .3s',
    position: 'absolute',
    top: '1px',
...
module.exports = Object.assign({}, body, wd, helpPanel.css, statusPanel.css, cto, pco);
