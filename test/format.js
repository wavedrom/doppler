...
const tt = [
  ...
  //                                                               |                  |
  {fmt: '%f64', val: -0x27c0aad9be68b8fbn, len: 64, pos: 20, res: '-1.234567890123e+117'},
  {fmt: '%e64', val: -0x27c0aad9be68b8fbn, len: 64, pos: 20, res: '-1.234567890123e+117'},
  {fmt: '%g64', val: -0x27c0aad9be68b8fbn, len: 64, pos: 20, res: '?'},
  //                                                               |                  |
  ...
  {fmt: '%g32', val: 0x42f6e979n, len: 32, pos: 20, res: '?'},
  //                                                      |                  |
  {fmt: '%f32', val: 0x374f07e5n, len: 32, pos: 20, res: '1.233999955729814e-5'},
  {fmt: '%e32', val: 0x374f07e5n, len: 32, pos: 20, res: '1.233999955729814e-5'},
  {fmt: '%g32', val: 0x374f07e5n, len: 32, pos: 20, res: '?'},
  //                                                      |      |
  {fmt: '%f32', val: 0x374f07e5n, len: 32, pos: 8,  res: '1.234e-5'},
  {fmt: '%e32', val: 0x374f07e5n, len: 32, pos: 8,  res: '1.234e-5'},
  {fmt: '%g32', val: 0x374f07e5n, len: 32, pos: 8,  res: '?'}
];
